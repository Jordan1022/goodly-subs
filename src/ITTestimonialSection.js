...
const ITTestimonialSection = () => {
  const [stackOrder, setStackOrder] = useState([0, 1]);

  const testimonials = [
    {
      title: "From JL Wood Electric:",
    ...
    {
      title: "From HenCon Constructors:",
  ...
  return (
    <TestimonialsContainer id="it-testimonials">
...
export default ITTestimonialSection;
